-- SCD2 invariants on silver.dim_user_hist. Each query returns 0 rows when clean.
...
-- 2. No overlapping intervals (an earlier version must end before the next starts).
