...
-- Window is hardcoded to the demo day (2024-01-01); a parameterized function
-- would avoid repeating the block - see docs/05.
-- Injects one late event into bronze + silver; step 5 tears it down.
